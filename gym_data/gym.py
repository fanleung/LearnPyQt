...
if __name__ == "__main__":
    filename = 'id1.jpg'                               # 要识别的图片名
    APP_ID = '17126510'                                 # 百度ai中心应用管理里获取
    API_Key = 'dBFwmo4uWyufwbpGXirCriAe'                # 百度ai中心应用管理里获取
    Secret_Key = 'nj3go0oFWqqNXZCxkmtOpuQ7AGgsStf4'     # 百度ai中心应用管理里获取
...
#         self.b_search = QtWidgets.QPushButton("查找")
#
#         # 添加按钮到按钮组中
...
#         self.b_search.clicked.connect(self.queryRecord)
#
#     # 创建数据库
#     def create_db(self):
#         try:
