...
def get_noise(img, value=100):
    """
    :param img: 图像
    :param value: 大小控制雨滴的多少
    :return: 返回图像大小的模糊噪声图像
    """
...
def rain_blur(noise, length=10, angle=0, w=7):
    '''
    将噪声加上运动模糊,模仿雨滴
...
noise = get_noise(img,value=500)
rain = rain_blur(noise,length=5,angle=-30,w=5)

# 方法1
alpha_rain(rain,img,beta=0.9)  #方法一，透明度赋值
